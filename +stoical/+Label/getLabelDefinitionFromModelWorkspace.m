...
%% Get Defined Labels
    ...
    if hws.hasVariable(NameOfWorkspaceVariable)
        ...
        stdnames = fieldnames(stoical.Label.getDefaultLabelDefinition());
    ...
    if IsDefault
        warning('STOICAL:LabelDefinition:NoLabelsDefined', 'No Labels defined in Model Workspace -> taking default');
        LabelDefinition = stoical.Label.getDefaultLabelDefinition();
    end
