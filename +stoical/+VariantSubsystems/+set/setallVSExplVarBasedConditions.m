...
%   Detailed explanation goes here
    ...
    VarSysPrefix = getfield(stoical.InternalDataStorage.getVariablePrefixes(),'Variants');
    ...
    suggested_namevariable = cellfun(@(x) [VarSysPrefix stoical.General.getmd5(x)],path_VS,'UniformOutput',false);
