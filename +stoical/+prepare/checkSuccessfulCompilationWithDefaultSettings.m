...
%% Now let the user test compilation error messages
    msgbox(sprintf(['Now try compiling your model with CTRL-D or PLAY. \n\n'...
                    'If error messages appear, fix the cause.\n\n'...
                    'Repeat until compilation is successful. \n\n'...
                    'Then redo the Activation Steps and SaveWithDefaultValues Step.\n\n'...
                    'Redo this check then.']),stoical.InternalDataStorage.getToolboxName());    
