...
if named_params.NrParams > 0
    ...
    ParameterPrefix = getfield(getVariablePrefixes(),'Parameters');


    suggested_namevariable = cellfun(@(x,y) [ParameterPrefix getmd5([x y])],ParBlkPath,ParName,'UniformOutput',false);
