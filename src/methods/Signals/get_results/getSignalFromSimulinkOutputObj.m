...
SignalLogNames = getOutputSignalContent( ...
...
LogVarNames2get = getAllSignalNamesForLabel( RegExp_Labelpath, STOICAL.SignalDefinition, SignalLogNames);

% Retrieve all the logged Signals from result object
LoggedSignals = getOutputSignal( evalin('caller',STOICAL.SignalSaveOptions.ReturnWorkspaceOutputsName),...
