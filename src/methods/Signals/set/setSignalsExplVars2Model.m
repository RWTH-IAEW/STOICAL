...
%   Detailed explanation goes here
    ...
    named_signals = getLogStatus(named_signals);
    
    logsigprefix = getfield(getVariablePrefixes(),'Signals');
    ...
    for iSig = 1:named_signals.NrSig
        ...
        named_signals.NameOfLogVar{iSig,1} = [logsigprefix getmd5(uniqueID)];
    end
